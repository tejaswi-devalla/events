...
class Events extends Component {
  state = {
    statusData: storingStatus.initial,
    clicked: '',
  }

  changeRegistrationStatus = (regStatus, id) => {
    this.setState({statusData: regStatus, clicked: id})
  }

  render() {
    const {statusData, clicked} = this.state
    return (
